...
@section('content')
    <div class="col-md-9 col-md-offset-1">
        ...
        <form id="assetForm" class="form-horizontal" action="/admin/companies/{{$company->companyID}}/edit" method="post"
            ...
            <fieldset>
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="companyName" name="companyName" type="text" class="form-control" value="{{ $company->name }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <a href="#" class="thumbnail" style="width: 200px">
                            <img src="{{$company->logo? '/testmate/images/'.$company->logo : 'http://placehold.it/200x200'}}" alt="">
                        </a>
                    </div>
                </div>
