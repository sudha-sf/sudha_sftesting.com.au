...
<div class="form-group">
    ...
    <div class="col-md-3">
        <input id="uploadDate" name="uploadDate" type="text" class="form-control" value="{{$asset['uploadDate']}}">
...
<div class="col-md-9">
<input id="name" name="name" type="text" class="form-control" required maxlength="450" value="{{$asset['name']}}">
</div>
</div>
...
<div class="col-md-9">
<textarea class="form-control" id="description" name="description" placeholder="" rows="5">{{$asset['description']}}</textarea>
</div>
</div>
